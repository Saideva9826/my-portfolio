export const projects = [
  {
    ...
    tags: [
      { _id: "tag1", _type: "tag", name: "Python" },
      { _id: "tag2", _type: "tag", name: "Data Pipeline" },
      { _id: "tag3", _type: "tag", name: "Analytics" },
    ],
  ...
  },
  {
    ...
    github: "https://github.com/Saideva9826",
    tags: [
      { _id: "tag4", _type: "tag", name: "Machine Learning" },
      { _id: "tag5", _type: "tag", name: "ARIMA" },
      { _id: "tag6", _type: "tag", name: "Data Science" },
    ],
    _createdAt: new Date().toISOString(),
    _updatedAt: new Date().toISOString(),
  },
  {
    ...
    github: "https://github.com/Saideva9826",
    tags: [
      { _id: "tag7", _type: "tag", name: "Computer Vision" },
      { _id: "tag8", _type: "tag", name: "AWS" },
      { _id: "tag9", _type: "tag", name: "Flask" },
    ],
    _createdAt: new Date().toISOString(),
    _updatedAt: new Date().toISOString(),
  },
  {
    ...
    github: "https://github.com/Saideva9826",
    tags: [
      { _id: "tag10", _type: "tag", name: "AI/ML" },
      { _id: "tag11", _type: "tag", name: "LangChain" },
      { _id: "tag12", _type: "tag", name: "NLP" },
    ],
    _createdAt: new Date().toISOString(),
    _updatedAt: new Date().toISOString(),
  },
